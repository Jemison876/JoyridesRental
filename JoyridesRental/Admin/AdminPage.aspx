<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="JoyridesRental.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td> <asp:TextBox ID="AddProductDescription" runat="server"></asp:TextBox> 
        ...
        <tr>
            ...
            <td> <asp:TextBox ID="AddProductPrice" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    Text="* Image path required." ControlToValidate="ProductImage" 
    ...
    <table>
       <tr>
         ...
         <td>
            <asp:DropDownList ID="DropDownList2" runat="server"
               ItemType="JoyridesRental.Models.Product"
      ...
      <tr>
         <td>
            <asp:Label ID="LabelUpdateCategory" runat="server">Category:</asp:Label>
         </td>
         <td>
      ...
      <tr>
         <td>
            <asp:Label ID="LabelUpdateName" runat="server">Name:</asp:Label>
         </td>
         <td>
      ...
      <tr>
         <td>
            <asp:Label ID="LabelUpdateDescription" runat="server">Description:</asp:Label>
         </td>
         <td>
      ...
      <tr>
         <td>
            <asp:Label ID="LabelUpdatePrice" runat="server">Price:</asp:Label>
         </td>
         <td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server" 
                    ItemType="JoyridesRental.Models.Product" SelectMethod="GetProducts" 
