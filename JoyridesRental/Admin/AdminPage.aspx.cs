    ...
    public partial class AdminPage : System.Web.UI.Page
    {
        ...
        protected void AddProductButton_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                ...
                bool addSuccess = products.AddProduct(AddProductName.Text, AddProductDescription.Text, AddProductPrice.Text, DropDownList3.SelectedValue, path1 + "/" + ProductImage.FileName);
                if (addSuccess)
                {
                    //Reload the page
        ...
        {
            var _db = new JoyridesRental.Models.ProductContext();
        ...
        {
            using (var _db = new JoyridesRental.Models.ProductContext())
            {
